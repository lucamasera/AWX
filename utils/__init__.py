...
datasets = {
    'enron': (
        False,
        os.environ['DATA_FOLDER'] + '/HMC_data/enron/Enron_corr_trainvalid.arff',
        os.environ['DATA_FOLDER'] + '/HMC_data/enron/Enron_corr_trainvalid.arff',
        os.environ['DATA_FOLDER'] + '/HMC_data/enron/Enron_corr_test.arff'
    ),
    'imclef07a': (
        False,
        os.environ['DATA_FOLDER'] + '/HMC_data/ImCLEF07A_Train.arff',
        os.environ['DATA_FOLDER'] + '/HMC_data/ImCLEF07A_Train.arff',
        os.environ['DATA_FOLDER'] + '/HMC_data/ImCLEF07A_Test.arff'
    ),
    'cellcycle_FUN': (
        False,
